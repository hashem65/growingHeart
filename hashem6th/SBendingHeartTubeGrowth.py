...
numberOfLengthElements=15 # Number of elements along the length of the tube
numberOfCircumfrentialElementsPerQuarter=4 # Number of elements in the circumfrential direction in one quarter of the tube
...
def SolveGrowthAndFittingProblems(time):
    ...
    y = dependentField.ParameterSetGetNodeDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,1,1,1,2)

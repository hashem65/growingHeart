...
heterogeneousFibreFactor = 2.0 # For fibre heteregeous problems, the fibre growth rates are multiplied by one plus the factor multiplied by the length fraction
heterogeneousSheetFactor = 2.0 # For heteregeous problems, the sheet growth rates are multiplied one plus the factor multiplied by cos(theta)
heterogeneousNormalFactor = 1.0 # For heteregeous problems, the normal growth rates are multiplied by one plus the factor multiplied by the wall fraction
